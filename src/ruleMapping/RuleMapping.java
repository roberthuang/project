...
//		    System.out.println(index + "  " + r + "  " + d);
		    ...
		    if (score_rise  > score_down) {
		    	result.add("Rise");
		    	System.out.println(index + "  Rise score high");
		    	//PRINT RESULT
//		    	osw.write("\r\n");
...
//		    	osw.write("d_s: " + down_set_size  +"\r\n");
//		    	osw.close();
		    	System.out.println(index + "  score equal, return default class");
		    	return answer;
		    } else {
		    	result.add("Down");
		    	//PRINT RESULT
...
//		    	osw.write("d_s: " + down_set_size  +"\r\n");
//		    	osw.close();
		    	System.out.println(index + "  Down score high");
				return result;	
		    }
...
//                	osw.close();	        	             
    ...
    public HashMap<String, Double> evaluate(HashMap<Integer, String> class_table , HashMap<Integer, ArrayList<String>> predict, int traing_data_size, int next_week, int records_size, double  min_conf, int min_sup) throws FileNotFoundException {
        ...
        double recall_down =  True_Negative / (double) (False_Positive+True_Negative);
